...
public class VacationTimeCalculator {
    ...
    public String calculateEntry(String entry1, String entry2) {
        ...
        if (entry1IsDate && entry2IsDate) {
            ...
            LocalDate startDate = LocalDate.of(startDateParts[2], startDateParts[0], startDateParts[1]);
            LocalDate endDate = LocalDate.of(endDateParts[2], endDateParts[0], endDateParts[1]);
